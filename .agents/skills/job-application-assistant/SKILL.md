...
description: >
  Assists with job applications and CV strategy: evaluating job postings, auditing uploaded CVs/resumes,
  researching current CV best practices, improving master CVs, deriving job-search keywords, tailoring CVs,
  writing cover letters, preparing for interviews, and starting targeted scraping. Triggers on keywords like:
  job posting, job application, CV audit, improve my CV, upload CV, resume review, cover letter, resume,
  interview prep, job fit, career, application, apply
...
When the user provides a CV/resume or asks to audit/improve a CV before searching, read `08-cv-audit.md` and follow that workflow before using the job-posting workflow below.
...
| `08-cv-audit.md` | CV upload, best-practice audit, improved master CV, and scrape setup workflow |
...
- "Audit/improve this CV" - Read `08-cv-audit.md` and run the CV audit-to-search workflow
